    ...
    <div className="flex min-h-[calc(100vh-6rem)] flex-col items-center justify-center px-6">
      <div className="max-w-xl text-center">
        ...
        <div className="space-y-6 text-left max-w-sm mx-auto mb-12">
          <motion.div initial={false} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="flex items-center gap-4">
          ...
          <motion.div initial={false} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex items-center gap-4">
          ...
          <motion.div initial={false} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex items-center gap-4">
        ...
        <motion.div initial={false} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.5 }}>
          <Link 
            href="/upload" 
